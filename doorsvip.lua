...
local Window = OrionLib:MakeWindow({Name = "MAPMAP DOORS", HidePremium = false, IntroEnabled = false, SaveConfig = true, ConfigFolder = "Doors Summon"})
...
OrionLib:MakeNotification({
    Name = "Made By",
    Content = " Me in my discord: skid#8272",
...
CreditsTab:AddParagraph("Credits to","AtsuageZ youtube")
